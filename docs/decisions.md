...
- **Finalizar** exige solo **una actividad descrita + firma del coordinador**; la **situación es opcional** (ratificado 2026-08-11 contra los 8 informes reales: los semanales no tienen ese campo). Alinea la doc con el código de Josune (`completitud.ts`).
