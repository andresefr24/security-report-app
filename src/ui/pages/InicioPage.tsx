// Pantalla de PRUEBA de marca (M0). Solo sirve para ver aplicados los tokens
// de color y la tipografía IBM Plex del design-system. En M1 empezaremos a
// sustituirla por pantallas reales (perfil del coordinador, etc.).
