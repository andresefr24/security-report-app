// Los escalones del COORDINADOR: cómo subir una ficha guardada hasta la forma de hoy.
//
 ...
 * v0 → v1 · Solo el sello.
 *
 * El coordinador no ha cambiado de forma, así que no hay nada que transformar. El
...
export const ESCALONES_COORDINADOR: Escalon[] = [soloSellar];
